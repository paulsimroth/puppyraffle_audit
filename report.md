...
- [Low Issues](#low-issues)
	...
	- [L-9: Loop condition contains `state_variable.length` that could be cached outside.](#l-9-loop-condition-contains-state_variablelength-that-could-be-cached-outside)
...
- Found in src/PuppyRaffle.sol [Line: 119](src/PuppyRaffle.sol#L119)
